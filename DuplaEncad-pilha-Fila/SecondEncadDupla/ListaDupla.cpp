...
void ListaDupla::removeAntProx(int val)
{
    NoDuplo* p = primeiro;
    while (p != NULL)
    {
        ...
        {
            if (p->getAnt() != NULL)
                removeOcorrencias(p->getAnt()->getInfo());
            else if (p->getProx() != NULL)
                removeOcorrencias(p->getProx()->getInfo());
            else if (p->getAnt() == NULL)
                cout << "Nao foi possivel remover, pois nao existe anterior a val!";
            else if (p->getProx() == NULL)
                cout << "Nao foi possivel remover, pois nao existe proximo a val!";
        }
        else
            cout << "Nao foi possivel remover, pois val nao existe na lista!";
        p = p->getProx();
    }
}